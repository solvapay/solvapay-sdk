...
For a new paid MCP server (Cloudflare Worker, paywall, and this widget), start with the scaffolder:

```bash
npm create solvapay@latest my-mcp-app -- --type mcp
```

Use the rest of this page when you already have an MCP server and want to mount the SolvaPay iframe yourself.
