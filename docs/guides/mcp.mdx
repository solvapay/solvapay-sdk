...
Full contract: [Add a free allowance to MCP tools](https://docs.solvapay.com/sdks/typescript/guides/free-allowance). The [mcp-checkout-app](https://github.com/solvapay/solvapay-sdk/tree/main/examples/mcp-checkout-app) example ships the two preview tools above.
