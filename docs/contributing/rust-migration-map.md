...
| Doc-comment coverage on generated signatures (redesign §5.6/§5.1, D19) | Owned by Steps 42T/45T (+ Step 18T for TS + shared infra, Step 47 Rust, Step 50 Go) | **Partial (18T + 42T + 45T Done for TS/Python/Ruby):** shared IR + TSDoc (18T); Python docstrings (42T, §15 note 51); Ruby YARD on generated client/helpers (45T, §15 note 52). Still open: Rust/Go in Steps 47/50 | SDK |
