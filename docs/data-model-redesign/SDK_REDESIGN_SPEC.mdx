---
title: "SDK Product Model Redesign Spec"
...
Based on decisions D1-D25 and Q1-Q17 from the [SDK Redesign Questionnaire](./SDK_REDESIGN_QUESTIONNAIRE.mdx).
...
- All example apps + shared utilities
...
32. Verify all examples build

### Phase 6: Docs and Release

33. Regenerate API docs: `pnpm typedoc`
34. Bump version to `1.0.0-preview.19`
35. Full monorepo build: `pnpm build`
36. Full test suite: `pnpm test`
37. Publish
...
- All example apps build and reference `NEXT_PUBLIC_PRODUCT_REF` / `SOLVAPAY_PRODUCT`.
