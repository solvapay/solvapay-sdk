  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-16">
      ...
      <p className="mt-3 text-muted-foreground">
        SolvaPay primitives composed with shadcn/ui via <code>asChild</code>. Behaviour comes from
        the primitives; appearance comes from the shadcn tokens and components.
      </p>
