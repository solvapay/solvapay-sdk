...
| Tool                      | Purpose                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `preview_market_quote`    | Free preview of a quote (price only). Shares a 5-call / 30-day `free-previews` allowance with `preview_company_profile` via `registerFree`.                                                                                                                                                                                                             |
| `preview_company_profile` | Free company-name preview on the same allowance.                                                                                                                                                                                                                                                                                                        |
