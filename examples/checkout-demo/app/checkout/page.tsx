  ...
  const handleCancelPlan = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        const errorMessage = errorData.error || 'Failed to cancel purchase'
        console.error('Cancel purchase error:', errorMessage, errorData)
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        {paymentFailed ? (
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
            <h2 className="text-xl font-semibold text-slate-900 mb-8">Choose your purchase</h2>
