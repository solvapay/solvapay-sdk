 ...
 */
export type CheckoutVariant = 'recurring' | 'oneTime' | 'topup' | 'usageMetered' | 'freeTier'
 ...
 */
export function deriveVariant(plan: Plan | null | undefined, mode?: 'topup'): CheckoutVariant {
