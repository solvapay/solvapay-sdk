...
export const enCopy: SolvaPayCopy = {
  ...
  autoRecharge: {
    ...
    targetAmountLabel: 'Fill up to target',
    fixedAmountAriaLabel: 'Fixed top-up amount',
    targetAmountAriaLabel: 'Target credits',
    switchToTarget: 'Switch to fill to target',
    switchToFixed: 'Switch to fixed amount',
    advancedLabel: 'Advanced',
    maxRechargesLabel: 'Max recharges (optional)',
    maxRechargesAriaLabel: 'Maximum recharges',
    saveButton: 'Save automatic top-up',
    ...
    statusCompleted: 'Recharge limit reached',
  },
  activationFlow: {
