...
export interface HostedCheckoutProps {
  ...
  /** When set, renders a back link at the top of the upgrade handoff. */
  onBack?: () => void
  /** Back link label; defaults to `"Change plan"`. */
  backLabel?: string
  cx: Cx
...
const UpgradeBody = React.memo(function UpgradeBody({
  ...
  return (
    <>
      ...
      <p className={cx.muted}>
        {
          "This host doesn't allow embedded payments. Open the SolvaPay checkout in a new tab to complete your purchase there. Return here after payment and your purchase will show up automatically."
        }
      </p>
      <HostedLinkButton
        state={checkout}
