...
import { getSharedDeduplicator, type RequestDeduplicationOptions, type SubscriptionCheckResult } from './cache';
...
export { clearSubscriptionCache, clearAllSubscriptionCache, getSubscriptionCacheStats } from './cache';
