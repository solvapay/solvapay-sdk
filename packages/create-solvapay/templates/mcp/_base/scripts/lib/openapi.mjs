...
/**
 * OpenAPI utilities for the scaffolded project's `test.mjs`.
 *
 * Re-parses the spec from disk on each run; no cached state across modules.
 *
 * Public surface:
 ...
 *
 * Depends on `@apidevtools/swagger-parser` (see `scripts/package.json`).
 */
...
/**
 * Lazy-load `@apidevtools/swagger-parser`. Run `npm install` inside
 * `scripts/` once before invoking `test.mjs`.
 */
