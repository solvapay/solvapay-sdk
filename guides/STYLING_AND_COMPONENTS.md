...
This guide describes how to replicate the styling and basic components from the hosted-checkout-demo example project in a new Next.js project. The design system uses Tailwind CSS with a clean, modern aesthetic featuring rounded corners, subtle shadows, and smooth transitions.
...
<Badge variant="credits">Credits</Badge>
<Badge variant="daypass">Day Pass</Badge>
```
...
4. Customize colors and spacing to match your brand if needed
5. Extend components as needed for your specific use cases

This styling system provides a clean, modern foundation that can be easily customized while maintaining consistency across your application.
