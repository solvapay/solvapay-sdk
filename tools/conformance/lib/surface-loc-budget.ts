...
export const SURFACE_LOC_BUDGETS = [
  { id: 'ts-client', rel: 'sdks/typescript/server/src/client.ts', maxCodeLines: 99 },
  ...
  { id: 'go-gate', rel: 'sdks/go/gate.go', maxCodeLines: 466 },
  { id: 'rust-client', rel: 'sdks/rust/src/client.rs', maxCodeLines: 812 },
  { id: 'ts-paywall', rel: 'sdks/typescript/server/src/paywall.ts', maxCodeLines: 792 },
