...
describe('paywall bindings', () => {
  ...
  it('buildGateMessage returns byte-exact topup copy with url clause', () => {
    ...
    expect(
      ...
      "Out of credits for this call. Balance 0 credits; this call costs 1 credits — 1 short. [Add credits](https://pay.test/x) to add credits (expires in 15 minutes), or call the `account` tool with view: 'topup'. Or call the `account` tool with view: 'checkout' to pick a plan.",
    )
  })
