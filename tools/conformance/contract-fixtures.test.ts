...
const NON_CLIENT_FIXTURES = [
  ...
  'customer-ref/anonymous-default.json',
  'customer-ref/jwt-beats-header.json',
  'driver-loop/gate-allow-omits-consequence.json',
  'driver-loop/gate-allow-overage-consequence.json',
  'driver-loop/gate-allow-throttled-consequence.json',
  'driver-loop/gate-handler-generic-error-emits-usage.json',
  'driver-loop/gate-handler-paywall-error-skips-usage.json',
  'driver-loop/gate-handler-success-emits-usage.json',
  'driver-loop/gate-limits-cache-hit-allow.json',
  'driver-loop/payable-run-gate-invoke-done.json',
  ...
  'free-limit/description-suffix-shared.json',
  'free-limit/description-suffix.json',
  'free-limit/limits-agree.json',
  'free-limit/limits-disagree-cap.json',
  'free-limit/normalize-bad-meter.json',
  'free-limit/normalize-default-meter.json',
  'free-limit/normalize-rolling-window-missing-days.json',
  'free-limit/normalize-uppercase-meter.json',
  ...
  'helper-limits/free-allowance-passthrough.json',
  'helper-limits/free-meter-wins.json',
  'helper-limits/is-unlimited-finite-positive.json',
  'helper-limits/is-unlimited-finite.json',
  'helper-limits/is-unlimited-sentinel.json',
  'helper-limits/is-unlimited-unexpected-negative.json',
  ...
  'helper-payment/topup-next-missing-pi.json',
  'helper-payment/topup-next-no-balance-skips-baseline.json',
  'helper-payment/topup-next-poll-delta.json',
  'helper-payment/topup-next-soft-success-no-baseline.json',
  'helper-payment/topup-next-start-sync.json',
  ...
  'helper-usage-retry/should-retry-customer-not-found.json',
  'helper-usage-retry/should-retry-other.json',
  ...
  'helper-usage/usage-extra-fail-empty.json',
  'helper-usage/usage-extra-free.json',
  'helper-usage/usage-extra-success-included.json',
  'helper-usage/usage-extra-success-overage.json',
  'helper-usage/used-absent.json',
  'helper-usage/whole-percent-integer.json',
  'mandate-legal/constants/solvapay-privacy-url.json',
  'mandate-legal/constants/solvapay-terms-url.json',
  'mandate-legal/constants/solvapay-website-url.json',
  'mandate-legal/resolve/merchant-both-urls.json',
  'mandate-legal/resolve/merchant-neither.json',
  'mandate-legal/resolve/merchant-no-display-name.json',
  'mandate-legal/resolve/merchant-terms-only.json',
  'mandate-legal/resolve/merchant-url-equals-solvapay.json',
  ...
  'money-format/price/free-default.json',
  'money-format/price/free-empty.json',
  'money-format/price/free-gratis.json',
  'money-format/price/gbp-whole.json',
  'money-format/price/interval-3-months.json',
  'money-format/price/interval-free.json',
  'money-format/price/interval-month.json',
  'money-format/price/interval-year.json',
  'money-format/price/jpy-1000.json',
  'money-format/price/sek-100.json',
  'money-format/price/sek-10050.json',
  'money-format/price/usd-1999.json',
  'money-format/price/usd-code.json',
  ...
  'paywall/classification/boundary-balance-equals-cost.json',
  'paywall/classification/boundary-cost-unknown-remaining-zero.json',
  'paywall/classification/boundary-no-credit-no-purchase.json',
  'paywall/classification/credit-allow-no-plan.json',
  'paywall/classification/needs-topup-flag.json',
  'paywall/classification/needs-topup-overrides-usage-heuristic.json',
  ...
  'paywall/classification/reason-limit-reached.json',
  ...
  'paywall/classification/row-5-payg-shortfall.json',
  'paywall/classification/row-6-zero-balance-credit-fields.json',
  'paywall/classification/row-7-included-usage-purchase-ref.json',
  'paywall/classification/row-9-failed-auto-upgrade.json',
  ...
  'paywall/decision/gate-next-cache-entry-absent.json',
  'paywall/decision/gate-next-cache-entry-fresh-allow.json',
  'paywall/decision/gate-next-cache-entry-stale-evicts.json',
  'paywall/decision/gate-next-cache-hit-allow.json',
  'paywall/decision/gate-next-cache-hit-gate.json',
  'paywall/decision/gate-next-cache-miss-check-limits.json',
  ...
  'paywall/ensure-customer/ensure-customer-next-anonymous-short-circuits.json',
  'paywall/ensure-customer/ensure-customer-next-backend-ref-short-circuits.json',
  'paywall/ensure-customer/ensure-customer-next-cache-stale-refetches.json',
  'paywall/ensure-customer/ensure-customer-next-conflict-unresolvable-fails.json',
  'paywall/ensure-customer/ensure-customer-next-create-conflict-refetch-by-external-ref.json',
  'paywall/ensure-customer/ensure-customer-next-create-email-conflict-retries-generated-email.json',
  'paywall/ensure-customer/ensure-customer-next-create-email-conflict-updates-external-ref.json',
  'paywall/ensure-customer/ensure-customer-next-lookup-404-proceeds-to-create.json',
  'paywall/ensure-customer/ensure-customer-next-lookup-found.json',
  'paywall/ensure-customer/ensure-customer-next-lookup-unexpected-error-fails.json',
  'paywall/ensure-customer/ensure-customer-next-no-create-capability-fails.json',
  'paywall/ensure-customer/ensure-customer-next-no-update-capability-skips-backfill.json',
  'paywall/ensure-customer/ensure-customer-next-start-cache-hit.json',
  'paywall/ensure-customer/ensure-customer-next-start-reads-cache.json',
  ...
  'paywall/messages/gate-limit-reached-free-meter-no-total.json',
  'paywall/messages/gate-limit-reached-free-meter-total.json',
  'paywall/messages/gate-limit-reached-hyphen-meter.json',
  ...
  'paywall/signals/credit-nested-wins.json',
  'paywall/signals/credit-shortfall.json',
  'paywall/signals/link-label-escapes.json',
  'paywall/signals/next-action-activation.json',
  'paywall/signals/next-action-limit-reached.json',
  'paywall/signals/next-action-reactivation.json',
  'paywall/signals/next-action-topup.json',
  'paywall/signals/next-action-upgrade.json',
  'paywall/signals/plan-ladder-cheapest-escaped.json',
  'paywall/signals/plan-ladder-no-checkout-url.json',
  'paywall/signals/remaining-calls-from-floor.json',
  'paywall/signals/remaining-calls-from-remaining-units.json',
  'paywall/signals/remaining-calls-from-remaining.json',
  ...
  'plan-pricing/credits-from-tiered-entry.json',
  ...
  'plan-pricing/meter-name-from-tier.json',
  ...
  'plan-pricing/usage-rate-tiered-floor.json',
  ...
  'tax-summary/constants/reverse-charge-note.json',
  'tax-summary/constants/tax-not-collected-note.json',
  'tax-summary/note/not-collecting.json',
  'tax-summary/note/not-supported.json',
  'tax-summary/note/reverse-charge.json',
  'tax-summary/note/standard-null.json',
  'tax-summary/should-show/missing.json',
  'tax-summary/should-show/none.json',
  'tax-summary/should-show/not-collecting.json',
  'tax-summary/should-show/not-supported.json',
  'tax-summary/should-show/reverse-charge.json',
  'tax-summary/should-show/standard.json',
  'tax-summary/subtotal-label/not-collecting.json',
  'tax-summary/subtotal-label/standard.json',
  'tax-summary/vat-label/fraction-25.json',
  'tax-summary/vat-label/reverse-charge.json',
  'tax-summary/vat-label/whole-25.json',
  'tax-summary/vat-label/zero-rate.json',
