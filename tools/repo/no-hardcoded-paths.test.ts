...
const ALLOWLIST = new Set([
  ...
  'conformance/check-residue-cap.ts',
  'conformance/check-touch-set.ts',
  'conformance/generated-driver-loop.test.ts',
  'conformance/lib/facade-decision-denylist.ts',
  'repo/lib/release-train.ts',
