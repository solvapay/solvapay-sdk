 ...
 * maps remain as unit-test fixtures for `manifest-schema.test.ts`.
 * Superseded by `gen:scaffold`; do not add new operations here.
 */

import type { OverlayTypeRef } from '../../shared/manifest-schema.js'
