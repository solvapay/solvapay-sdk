//! Ruby signature-parity suite renderer.
...
/// Renders `test/signature_parity_generated_test.rb` from the shared descriptor.
pub(super) fn render(desc: &ParitySuiteDescriptor) -> GenResult<String> {
    ...
    let mut operations: Vec<_> = desc.ruby_client_ops.iter().collect();
    ...
    for helper in &desc.ruby_helpers {
...
mod tests {
    use crate::emit_parity_suite_rb;
    use crate::ir::Ir;
