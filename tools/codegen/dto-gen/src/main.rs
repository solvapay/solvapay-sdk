...
fn apply_input_flag(
    ...
    match flag {
        ...
        "--ts-envelope-out" => outputs.ts_envelope_out = Some(path),
        ...
        "--boundary-asserts-rs-out" => outputs.boundary_asserts_rs_out = Some(path),
        ...
        "--ts-defaults-out" => outputs.ts_defaults_out = Some(path),
        "--py-defaults-out" => outputs.py_defaults_out = Some(path),
        "--rb-defaults-out" => outputs.rb_defaults_out = Some(path),
        "--go-defaults-out" => outputs.go_defaults_out = Some(path),
        "--rs-defaults-out" => outputs.rs_defaults_out = Some(path),
        "--transport-defaults-out" => outputs.transport_defaults_out = Some(path),
...
struct OwnedOutputs {
    ...
    ts_envelope_out: Option<PathBuf>,
    ...
    boundary_asserts_rs_out: Option<PathBuf>,
    ...
    ts_defaults_out: Option<PathBuf>,
    py_defaults_out: Option<PathBuf>,
    rb_defaults_out: Option<PathBuf>,
    go_defaults_out: Option<PathBuf>,
    rs_defaults_out: Option<PathBuf>,
    transport_defaults_out: Option<PathBuf>,
...
impl OwnedOutputs {
    fn borrowed(&self) -> GenOutputs<'_> {
        GenOutputs {
            ...
            ts_envelope_out: self.ts_envelope_out.as_deref(),
            ...
            boundary_asserts_rs_out: self.boundary_asserts_rs_out.as_deref(),
            ...
            ts_defaults_out: self.ts_defaults_out.as_deref(),
            py_defaults_out: self.py_defaults_out.as_deref(),
            rb_defaults_out: self.rb_defaults_out.as_deref(),
            go_defaults_out: self.go_defaults_out.as_deref(),
            rs_defaults_out: self.rs_defaults_out.as_deref(),
            transport_defaults_out: self.transport_defaults_out.as_deref(),
