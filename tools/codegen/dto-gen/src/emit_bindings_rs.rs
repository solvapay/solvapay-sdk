...
pub fn emit_bindings(ir: &Ir, toolchain: Toolchain) -> GenResult<EmittedBindings> {
    ...
    match toolchain {
        Toolchain::Ruby => {
            ...
            Ok(EmittedBindings {
                args_rs: with_generated_header(chrome_str(python_art, &["argsRs"])?, Toolchain::Ruby),
...
fn emit_python_register(ir: &Ir) -> GenResult<String> {
    ...
    let header = generated_header(crate::header::CommentStyle::ModuleDoc, "python-bindings-out");
    Ok(format!(
...
fn strip_generated_prefix(content: &str) -> &str {
    ...
    loop {
        let Some((line, tail)) = rest.split_once('\n') else {
            if rest.contains("@generated") || rest.contains("Code generated by dto-gen. DO NOT EDIT.") {
                return "";
            }
            return rest;
        };
...
fn with_generated_header(content: &str, toolchain: Toolchain) -> String {
    let header = generated_header(crate::header::CommentStyle::ModuleDoc, bindings_flag(toolchain));
