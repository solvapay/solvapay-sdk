...
const OUT_PATH = join(REPO_ROOT, 'tools', 'codegen', 'dto-gen', 'assets', 'binding-emit.snapshot.json');

const FILES = {
  node: {
    decisions: join(REPO_ROOT, 'sdks', 'node-native', 'src', 'decisions.rs'),
    payloadBuilders: join(REPO_ROOT, 'sdks', 'node-native', 'src', 'payload_builders.rs'),
    client: join(REPO_ROOT, 'sdks', 'node-native', 'src', 'native_client.rs'),
    argsRs: join(REPO_ROOT, 'sdks', 'node-native', 'src', 'args.rs'),
  },
  wasm: {
    decisions: join(REPO_ROOT, 'sdks', 'wasm', 'src', 'decisions.rs'),
    payloadBuilders: join(REPO_ROOT, 'sdks', 'wasm', 'src', 'payload_builders.rs'),
    client: join(REPO_ROOT, 'sdks', 'wasm', 'src', 'wasm_client.rs'),
    argsRs: join(REPO_ROOT, 'sdks', 'wasm', 'src', 'args.rs'),
  },
};
