//! Sync JSON-envelope napi exports for decision / paywall / retry cores (Step 37R-c).
//!
...
#[napi(js_name = "classifyCustomerRef")]
...
#[napi(js_name = "coerceCustomerOptions")]
...
#[napi(js_name = "buildCreateCustomerParams")]
...
#[napi(js_name = "extractBackendCustomerRef")]
...
#[napi(js_name = "classifyLookupError")]
...
#[napi(js_name = "classifyCreateError")]
...
#[napi(js_name = "validateActivatePlanParams")]
...
#[napi(js_name = "validateCreatePaymentIntentParams")]
...
#[napi(js_name = "validateTopupPaymentIntentParams")]
...
#[napi(js_name = "validateProcessPaymentIntentParams")]
...
#[napi(js_name = "validateAttachBusinessDetailsParams")]
...
#[napi(js_name = "attachBusinessDetailsValidationError")]
...
#[napi(js_name = "projectPaymentIntentResult")]
...
#[napi(js_name = "projectTopupProcessOutcome")]
...
#[napi(js_name = "validateCheckoutSessionParams")]
...
#[napi(js_name = "isCachedCustomerRefValid")]
...
#[napi(js_name = "resolvePurchaseCustomerRef")]
...
#[napi(js_name = "selectActivePurchases")]
...
#[napi(js_name = "classifyCancelError")]
...
#[napi(js_name = "classifyReactivateError")]
...
#[napi(js_name = "normalizeCancelResponse")]
...
///
/// Ok and Err ([`HelperErrorResult`]) both serialize as the envelope **value**.
#[napi(js_name = "normalizeReactivateResponse")]
...
#[napi(js_name = "validatePurchaseRef")]
...
#[napi(js_name = "projectUsageSnapshot")]
...
///
/// Ok and Err ([`HelperErrorResult`]) both serialize as the envelope **value**.
#[napi(js_name = "resolveCheckLimitsParams")]
...
#[napi(js_name = "validateListPlansParams")]
...
#[napi(js_name = "validateGetProductParams")]
...
#[napi(js_name = "resolveProductRef")]
...
#[napi(js_name = "evaluateCachedLimits")]
...
#[napi(js_name = "evaluateFreshLimits")]
...
#[napi(js_name = "decidePaywallOutcome")]
...
#[napi(js_name = "resolveFallbackGateLimits")]
...
#[napi(js_name = "classifyPaywallState")]
...
#[napi(js_name = "buildNudgeMessage")]
...
#[napi(js_name = "paywallErrorToClientPayload")]
