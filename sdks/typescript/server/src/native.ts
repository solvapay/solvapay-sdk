/**
 * @generated by dto-gen (--native-ts-out) — do not edit. Regenerate with: pnpm gen
 */
...
import { assertLoadedNativeMatchesPackage } from './version-skew'
 ...
 *
 * A failed require is the optional-native path (addon not installed). That
 * returns null and does not throw. A loaded binary whose `nativeBuildInfo`
 * stamp disagrees with this package throws `version_skew`. Test overrides
 * skip the guard — they are not a loaded binary.
 */
export function loadNativeBinding(): NativeBinding | null {
  ...
  if (cachedBinding === undefined || cachedBinding === null) {
    return null
  }
  assertLoadedNativeMatchesPackage(cachedBinding)
...
export async function callNative(
  ...
  return unwrapEnvelope(envelopeJson, 'native binding')
}
