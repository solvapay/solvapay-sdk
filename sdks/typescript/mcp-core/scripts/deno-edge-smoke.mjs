 ...
 *   deno run --sloppy-imports --allow-env --allow-read=. \
 *     sdks/typescript/mcp-core/scripts/deno-edge-smoke.mjs
 */
import { pathToFileURL } from 'node:url'
import { join } from 'node:path'
import { tsPackageDir } from '../../../../tools/shared/paths.ts'

const serverEdge = pathToFileURL(join(tsPackageDir('server'), 'dist', 'edge.js')).href
const mcpCore = pathToFileURL(join(tsPackageDir('mcp-core'), 'dist', 'index.js')).href
