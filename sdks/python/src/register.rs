...
pub(crate) fn register_generated(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_function(wrap_pyfunction!(free_meter_name_pattern_binding, m)?)?;
    m.add_function(wrap_pyfunction!(build_create_customer_params_binding, m)?)?;
    m.add_function(wrap_pyfunction!(normalize_free_limit_binding, m)?)?;
    m.add_function(wrap_pyfunction!(extract_backend_customer_ref_binding, m)?)?;
    m.add_function(wrap_pyfunction!(free_limits_agree_binding, m)?)?;
    m.add_function(wrap_pyfunction!(classify_lookup_error_binding, m)?)?;
    m.add_function(wrap_pyfunction!(free_tool_description_suffix_binding, m)?)?;
    ...
    m.add_function(wrap_pyfunction!(credit_signals_binding, m)?)?;
    m.add_function(wrap_pyfunction!(ensure_customer_next_binding, m)?)?;
    m.add_function(wrap_pyfunction!(charges_binding, m)?)?;
    m.add_function(wrap_pyfunction!(next_action_for_binding, m)?)?;
    ...
    m.add_function(wrap_pyfunction!(link_label_binding, m)?)?;
    m.add_function(wrap_pyfunction!(per_unit_charge_binding, m)?)?;
    m.add_function(wrap_pyfunction!(plan_ladder_binding, m)?)?;
    m.add_function(wrap_pyfunction!(append_paid_tool_description_binding, m)?)?;
    m.add_function(wrap_pyfunction!(billing_cycle_binding, m)?)?;
    m.add_function(wrap_pyfunction!(trial_days_binding, m)?)?;
    m.add_function(wrap_pyfunction!(included_units_binding, m)?)?;
    m.add_function(wrap_pyfunction!(pegged_credits_per_unit_binding, m)?)?;
    m.add_function(wrap_pyfunction!(credits_per_unit_from_balance_binding, m)?)?;
    m.add_function(wrap_pyfunction!(meter_name_binding, m)?)?;
    m.add_function(wrap_pyfunction!(counts_usage_binding, m)?)?;
    ...
    m.add_function(wrap_pyfunction!(solvapay_terms_url_binding, m)?)?;
    ...
    m.add_function(wrap_pyfunction!(format_subtotal_label_binding, m)?)?;
    m.add_function(wrap_pyfunction!(solvapay_privacy_url_binding, m)?)?;
    m.add_function(wrap_pyfunction!(to_major_units_binding, m)?)?;
    m.add_function(wrap_pyfunction!(format_vat_summary_label_binding, m)?)?;
    m.add_function(wrap_pyfunction!(resolve_tax_behavior_binding, m)?)?;
    m.add_function(wrap_pyfunction!(solvapay_website_url_binding, m)?)?;
    m.add_function(wrap_pyfunction!(get_tax_id_example_binding, m)?)?;
    m.add_function(wrap_pyfunction!(resolve_mandate_legal_docs_binding, m)?)?;
    m.add_function(wrap_pyfunction!(resolve_tax_treatment_note_binding, m)?)?;
    m.add_function(wrap_pyfunction!(reverse_charge_note_binding, m)?)?;
    m.add_function(wrap_pyfunction!(get_tax_id_field_label_binding, m)?)?;
    m.add_function(wrap_pyfunction!(tax_not_collected_note_binding, m)?)?;
