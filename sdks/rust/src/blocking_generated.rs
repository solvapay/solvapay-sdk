// @generated by dto-gen (--rs-client-out) — do not edit. Regenerate with: pnpm gen
...
impl BlockingClient {
    ...
    pub fn mcp_bootstrap(
        &self,
        params: solvapay_transport::McpBootstrapParams,
    ) -> Result<Value, SdkError> {
        runtime().block_on(self.inner.mcp_bootstrap(params))
    }
    ...
    pub fn mcp_call_builtin_tool(
        &self,
        params: solvapay_transport::McpCallBuiltinToolParams,
    ) -> Result<Value, SdkError> {
        runtime().block_on(self.inner.mcp_call_builtin_tool(params))
    }
    ...
    pub fn mcp_dispatch(
        ...
        runtime().block_on(self.inner.mcp_dispatch(params))
    }
    ...
    pub fn mcp_oauth_request(
        &self,
        params: solvapay_transport::McpOauthRequestParams,
    ) -> Result<Value, SdkError> {
        runtime().block_on(self.inner.mcp_oauth_request(params))
    }
