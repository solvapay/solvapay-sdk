...
use solvapay_core::{
    assert_response_result, balance_reconcile_delays_ms, build_payable_tool_result,
    ...
    credits_to_display_minor_units, derive_icons, derive_tax_id_type, format_price,
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_resolve_buyer_country_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_get_customer_address_field_errors_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_is_customer_address_complete_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_is_postal_code_required_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_is_state_required_binding(args_ptr: *mut u8, args_len: usize) -> u64 {
    let args_json = read_string(args_ptr, args_len);
    pack(run_envelope_sync(|| {
        let args = args_map(&args_json)?;
        let country = require_string(&args, "country")?;
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_get_state_field_label_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_get_postal_code_field_label_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_get_postal_code_placeholder_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_postal_code_required_countries_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_state_required_countries_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_tax_id_types_binding(args_ptr: *mut u8, args_len: usize) -> u64 {
    let args_json = read_string(args_ptr, args_len);
    pack(run_envelope_sync(|| {
        let _args = args_map(&args_json)?;
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_business_country_options_table_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_is_tax_id_type_binding(args_ptr: *mut u8, args_len: usize) -> u64 {
    let args_json = read_string(args_ptr, args_len);
    pack(run_envelope_sync(|| {
        let args = args_map(&args_json)?;
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_business_country_display_names_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_supported_business_countries_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_country_to_tax_id_type_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_tax_id_example_by_country_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_tax_behaviors_binding(args_ptr: *mut u8, args_len: usize) -> u64 {
    let args_json = read_string(args_ptr, args_len);
    pack(run_envelope_sync(|| {
        let _args = args_map(&args_json)?;
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_tax_exclusive_currencies_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_topup_balance_poll_delays_ms_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_balance_reconcile_delays_ms_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
