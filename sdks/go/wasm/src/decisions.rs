...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_select_active_plan_purchase_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_should_retry_usage_error_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_paywall_structured_content_schema_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_credit_signals_binding(args_ptr: *mut u8, args_len: usize) -> u64 {
    let args_json = read_string(args_ptr, args_len);
    pack(run_envelope_sync(|| {
        let args = args_map(&args_json)?;
        let limits = optional_typed::<PaywallLimits>(&args, "limits")?;
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_ensure_customer_next_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_next_action_for_binding(args_ptr: *mut u8, args_len: usize) -> u64 {
    let args_json = read_string(args_ptr, args_len);
    pack(run_envelope_sync(|| {
        let args = args_map(&args_json)?;
        let state = require_typed::<PaywallState>(&args, "state")?;
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_link_label_binding(args_ptr: *mut u8, args_len: usize) -> u64 {
    let args_json = read_string(args_ptr, args_len);
    pack(run_envelope_sync(|| {
        let args = args_map(&args_json)?;
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_plan_ladder_binding(args_ptr: *mut u8, args_len: usize) -> u64 {
    let args_json = read_string(args_ptr, args_len);
    pack(run_envelope_sync(|| {
        let args = args_map(&args_json)?;
        let gate = require_typed::<GateContent>(&args, "gate")?;
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_append_paid_tool_description_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_meter_name_binding(args_ptr: *mut u8, args_len: usize) -> u64 {
    let args_json = read_string(args_ptr, args_len);
    pack(run_envelope_sync(|| {
        let args = args_map(&args_json)?;
        let priced = optional_value(&args, "priced");
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_counts_usage_binding(args_ptr: *mut u8, args_len: usize) -> u64 {
    let args_json = read_string(args_ptr, args_len);
    pack(run_envelope_sync(|| {
        let args = args_map(&args_json)?;
        let priced = optional_value(&args, "priced");
...
/// `args_ptr` / `args_len` must describe a valid guest allocation from `sv_alloc`.
#[no_mangle]
pub unsafe extern "C" fn sv_build_customer_snapshot_binding(
    args_ptr: *mut u8,
    args_len: usize,
) -> u64 {
    let args_json = read_string(args_ptr, args_len);
