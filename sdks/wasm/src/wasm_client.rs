...
//!
//! Edge-only mirror of `sdks/node-native/src/native_client.rs`. Wraps the
...
impl WasmClient {
    ...
    /// `mcpBootstrap`
    #[wasm_bindgen(js_name = "mcpBootstrap")]
    ...
    /// `mcpReadResource`
    #[wasm_bindgen(js_name = "mcpReadResource")]
    ...
    /// `mcpResolveAuth`
    #[wasm_bindgen(js_name = "mcpResolveAuth")]
    ...
    /// `mcpOauthRequest`
    #[wasm_bindgen(js_name = "mcpOauthRequest")]
    ...
    /// `mcpDispatch`
    #[wasm_bindgen(js_name = "mcpDispatch")]
